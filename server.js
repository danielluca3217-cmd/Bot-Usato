...
// WHITELIST ADMIN
// ============================================================
// La tabella admin_whitelist viene gestita direttamente dal bot Discord
// (index.js), che si collega allo stesso Postgres tramite l'host
// pubblico e scrive/legge la tabella con query dirette (comandi
// /admin-add, /admin-remove, /admin-list). Qui il backend web si limita
// a LEGGERLA per decidere se una sessione Discord ha i permessi admin:
// non serve nessun endpoint HTTP dedicato né una chiave condivisa.
// ============================================================
